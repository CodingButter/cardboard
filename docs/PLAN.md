...
| `docs/plans/EDITOR_ENGINE.md` | Editor Engine — shell + editor packs on pack-chain. Dock-type catalog, JSON-declarative panels, bundled npm libraries, Extensions tab, dev-mode injection. Synthesizes dogfooding + editor-package-injection + IDB + DnD + remote-dock memories. | Designed; phases 0–5. |

  ...
  return (
    ...
    >
      <FilterChipRow
        ...
        canClear={allProblems.length > 0}
        canJumpFirst={allProblems.some((p) => p.cell !== null)}
      />

      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
        {visibleProblems.length === 0 ? (
          <EmptyState filter={filter} cleared={cleared} />
        ) : (
...
function FilterChipRow({
  ...
  return (
    <div className="shrink-0 h-6 flex items-center gap-1 min-w-0">
...
// ---------------------------------------------------------------------------
// Empty state — mirrors CellInspectorPanel's "No cell selected" pattern.
  ...
  const label = cleared
    ...
    : filter === "all"
      ...
      : filter === "warn"
        ...
        : "No errors";
  return (
    <div className="h-full w-full flex items-center justify-center text-center px-2">
